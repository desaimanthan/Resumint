...
export function VoiceInterviewAgent({
    ...
    try {
      ...
      processor.onaudioprocess = (event) => {
        if (wsRef.current && wsRef.current.readyState === WebSocket.OPEN) {
          ...
          // Send to OpenAI
          console.log('Sending audio data to OpenAI, length:', base64Audio.length)
  ...
  }, [transcript, onTranscriptUpdate, onError, playAudioChunk, stopCurrentAudio])
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Voice Interview Agent (ScriptProcessor)
          </CardTitle>
          <CardDescription>
            {isConnected 
